...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/trame-client-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/trame-client-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add trame-client
# for installing globally
pixi global install trame-client
```
...
It is possible to list all of the versions of `trame-client` available on your platform:
...
```
pixi search trame-client --channel conda-forge
```
